...
#  with some updates from Jeff Epler
#  hacked into a module and updated by Jez Higgins
# ----------------------------------------------------------------------
import re, random, os, subprocess, math, sys
import speech_recognition as sr


#-----------------------------------------------------------------------
# check if the user has specified a particular voice
# the voice must be installed via the accessabilities
# section in OSX
#-----------------------------------------------------------------------
def say(text):
    if sys.argv[1:]:
    ...
    def respond(self, str):
        ...
        for i in range(0, len(self.keys)):
            ...
            if match:
                ...
                if resp[-2:] == '??': resp = resp[:-2] + '?'
                #-------------------------------------------------------
		#  say the response by calling the subprocess command
		#  to execute the say program in OSX 
		#--------------------------------------------------------
                say(resp)
                return (resp)
